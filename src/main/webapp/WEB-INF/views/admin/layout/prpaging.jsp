...
<div class="paging">
   ...
   <li class="page-item"><a class="page-link" href="${url }?curPage=1${query }">처음</a></li>
   </c:if>
...
<%--    </c:if> --%>
   ...
   <!-- 끝 페이지로 가기 -->
      <c:if test="${paging.curPage ne paging.totalPage}">
   <li class="page-item"><a class="page-link" href="${url }?curPage=${paging.totalPage }${query }">끝</a></li>
   </c:if>
   </ul>
</div>