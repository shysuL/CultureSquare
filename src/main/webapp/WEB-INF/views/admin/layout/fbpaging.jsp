...
<div style="text-align: center;">
   ...
   <li><a class="page-link"  href="${url }?curPage=${paging.startPage - paging.pageCount }${query }">&laquo;</a></li>
   </c:if>
...
<%--    </c:if> --%>
   ...
   <!-- 이전 페이지로 가기 -->
   <c:if test="${paging.curPage ne 1  }">
   <li><a class="page-link"  href="${url }?curPage=${paging.curPage - 1 }${query }">
   &lt;</a></li>
   </c:if>	
	...
	<li><a class="page-link" href="${url }?curPage=${paging.curPage + 1 }${query }">&gt;</a></li>
	</c:if>
	
	<!-- 다음 페이징 리스트로 가기 -->
	<c:if test="${paging.endPage ne paging.totalPage }">
	<li><a class="page-link" href="${url }?curPage=${paging.startPage + paging.pageCount }${query }">&raquo;</a>
	</c:if>
...
<%-- 	</c:if> --%>
	...
	<!-- 끝 페이지로 가기 -->
	<c:if test="${paging.curPage ne paging.totalPage }">
	<li><a class="page-link" href="${url }?curPage=${paging.totalPage }${query }">&rarr;끝</a></li>
